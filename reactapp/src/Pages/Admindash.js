        ...
        <nav className={`sidebar ${isSidebarOpen ? '' : 'close'} ${isDarkMode ? 'dark' : ''}`}>
          ...
          <div className="menu-bar">
            ...
            <li className="nav-link">
              <a href="#">
                <BiUser className='icon' onClick={handleget}/>
                <span className="text nav-text" onClick={handleget}>Users Details</span>
              </a>
            </li>
            ...
            <li className="nav-link">
              <a href="#">
                <RiFolderHistoryFill className='icon' onClick={handlehistory}/>
                <span className="text nav-text" onClick={handlehistory}>Login History</span>
              </a>
            </li>
